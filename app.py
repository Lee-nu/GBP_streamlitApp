...
oldbalanceOrg = st.sidebar.number_input('Old Balance Origin', min_value=0.0, value=0.0)
newbalanceOrig = st.sidebar.number_input('New Balance Origin', min_value=0.0, value=0.0)
